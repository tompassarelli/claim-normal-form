...
VALID_TRANSITIONS = {
    ...
    "in_progress": ["resolved", "open", "on_hold", "duplicate"],
...
TERMINAL_STATUSES = ["closed", "archived", "duplicate"]
...
def mark_duplicate_ticket(ticket_id):
    return transition_ticket(ticket_id, "duplicate")
...
def is_duplicate(ticket):
    return ticket.status == "duplicate"
