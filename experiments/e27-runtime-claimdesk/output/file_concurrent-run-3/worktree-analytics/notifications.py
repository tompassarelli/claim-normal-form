...
from workflow import TERMINAL_STATUSES, SUSPENDED_STATUSES
...
def notify_transition(ticket_id, old_status, new_status):
    # Terminal transitions are silent (ticket is done); all others notify including suspended.
    # Suspended is intentionally non-silent: subscribers should know work is paused.
